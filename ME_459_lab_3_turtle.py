# -*- coding: utf-8 -*-
"""
Created on Sat Feb  5 22:28:52 2022
...
def compute_distance(current_pos, another_pos):
    """compute distance"""
    distance = math.sqrt((another_pos[0] - current_pos[0])**2+(another_pos[1]- current_pos[1])**2)
    return distance
    ...
    while [current_node.x, current_node.y] != goal_position:
        ...
        for move in turtle.move_list:
            ...
            if configSpace.check_within_obstacle(
                    obstacle_list, new_position, obstacle_radius) == True:
